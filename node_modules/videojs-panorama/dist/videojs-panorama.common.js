...
module.exports = (function () {
    ...
    function Panorama(settings) {
        ...
        this.camera = new THREE.PerspectiveCamera(this.settings.initFov, this.width / this.height, 1, 2000);
    ...
    Panorama.prototype.render = function() {
        ...
        if (!this.isRendering || Date.now() - this.lastFrameRendered < (1000 / this.fps)) return;
