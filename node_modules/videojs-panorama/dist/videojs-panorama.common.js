...
module.exports = (function () {
    ...
    function Panorama(settings) {
        ...
        this.loadTexture(this.settings);
        this.attachControlEvents();
    }

    Panorama.prototype.loadTexture = function(settings) {
        var texture;

        this.settings.sourceType = settings.sourceType;
        this.settings.sourceSize = settings.sourceSize;

        switch (settings.sourceType) {
            case 'video':
                texture = new THREE.Texture( settings.texSource );
                texture.generateMipmaps = false;
                texture.minFilter = THREE.LinearFilter;
                texture.maxFilter = THREE.LinearFilter;
                texture.format = THREE.RGBFormat;
                this.settings.sourceType = 'video';
                this.onTextureLoaded(texture);
                break;
            case 'image':
                var loader = new THREE.TextureLoader();
                loader.load( settings.texSource, function(_texture) {
                    this.onTextureLoaded(_texture);
                }.bind(this));
                break;
        }
    }
    ...
    Panorama.prototype.render = function() {
        ...
        if (this.settings.sourceType == 'video') this.mesh.material.map.needsUpdate = true;
