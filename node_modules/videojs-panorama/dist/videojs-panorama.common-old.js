    ...
    return {
        constructor: function init(player, options) {
            ...
            this.player().on("play", function () {
                ...
                if (!this.requestAnimationId) this.animate();
        ...
        animate: function animate() {
            ...
            if (this.destroyed || this._pause) return;
        ...
        destroy: function destroy() {
          ...
          if (typeof this.requestAnimationId !== 'undefined') cancelAnimationFrame(this.requestAnimationId);
    ...
    return util.extend(parent, {
        constructor: function init(player, options) {
            ...
            if (options.sourceType == 'video') {
              this.onTextureLoaded(geometry, options);
            } else {
              var loader = new THREE.TextureLoader();
              loader.load( options.imageSource, function(texture) {
        ...
        onTextureLoaded: function onTextureLoaded(geometry, options) {
          ...
          if (options.hotspots) {
            ...
            for (var i = 0; i < options.hotspots.length; i++) {
              var hotspotData = options.hotspots[i],
                  g = new THREE.SphereGeometry( 20, 32, 32 ),
                  m = new THREE.MeshBasicMaterial( {color: 0xffffff} ),
                  mesh = new THREE.Mesh( g, m ),
                  phi = THREE.Math.degToRad( (360 / options.sourceSize.width) * hotspotData.coords[1] ),
                  theta = THREE.Math.degToRad( 180 - ((180 / options.sourceSize.height) * hotspotData.coords[0]) ),
